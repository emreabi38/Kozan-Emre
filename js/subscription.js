...
const SUBSCRIPTION_PLANS = {
    ...
    'standard': {
        ...
        monthly: 14.90,
        features: [
            'Alles aus Basic + mehr',
            'Bis zu 3 Seiten',
            'Kostenlose Domain (1 Jahr)',
            'Business Email',
            'Erweiterte SEO',
            '20 Min/Monat Wartung'
        ]
    },
    'premium': {
        name: 'Premium',
        ...
        features: [
            ...
            'Bis zu 5 Seiten',
            'Premium Domain (.com/.de)',
            'Mehrere Business-Emails',
                ...
                <div class="paypalme-card">
                    ...
                    <div class="direct-pay">
                        ...
                        <a href="${subscriptionData.paypalMeLink}" target="_blank" class="paypalme-btn">
                            <i class="fab fa-paypal"></i> Jetzt ${plan.month❌ Fehler beim Laden:", error);
        return null;
    }
}
            ...
            <div class="paypalme-section">
                ...
                <div class="paypalme-card">
                    ...
                    <div class="direct-pay">
                        <p><strong>Oder klicke direkt:</strong></p>
                        <a href="${subscriptionData.paypalMeLink}" target="_blank" class="paypalme-btn">
                            <i class="fab fa-paypal"></i> Jetzt ${plan.monthly.toFixed(2).replace('.', ',')}€ bezahlen
                        </a>
                    </div>
                </div>
                ...
                <div class="payment-schedule">
                    ...
                    <div class="timeline">
                        ...
                        <div class="timeline-item">
                            <div class="timeline-icon">🚀</div>
                            <div class="timeline-content">
                                <div class="timeline-title">2-10 Tage</div>
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                ...
                                <div class="timeline-desc">Erste ${plan.monthly.toFixed(2).replace('.', ',')}€ Zahlung</div>
                            </div>
                        </div>
                    </div>
                </div>
...
function sendLinkByEmail(email, link, amount) {
    const subject = `Dein PayPal.me Link - ${amount.toFixed(2).replace('.', ',')}€/Monat`;
    const body = `
Hallo!
...
2. Bezahle ${amount.toFixed(2).replace('.', ',')}€
3. Das war's! Wiederhole dies jeden Monat

📅 Nächste Zahlung: In 30 Tagen
💶 Betrag: ${amount.toFixed(2).replace('.', ',')}€ pro Monat
...
function sendSubscriptionEmail(subscription) {
    ...
    const emailData = {
        ...
        body: `
            ...
            - Anzahlung: ${subscription.deposit.toFixed(2).replace('.', ',')}€
            - Monatlich: ${subscription.monthly.toFixed(2).replace('.', ',')}€
            ...
            3. Deine Website wird in 2-10 Tagen fertiggestellt
...
document.addEventListener('DOMContentLoaded', function() {
    console.log("💰 Subscription System initial❌ Fehler beim Laden:", error);
        return null;
    }
}
...
// GEÄNDERT: Keine Abonnement-Details mehr anzeigen
function showSubscriptionInfo() {
    // Funktion deaktiviert - keine Details-Anzeige mehr
    return;
}
