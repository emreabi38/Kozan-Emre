            ...
            <div class="order-summary-box">
                ...
                <div class="details-grid">
                    ...
                    <div class="detail-item">
                        ...
                        <span class="value">${plan.deposit}€ ✅</span>
                    </div>
                    <div class="detail-item">
                        <span class="label">Monatlich:</span>
                        <span class="value highlight">${plan.monthly}€</span>
                    </div>
                    <div class="detail-item">
                ...
                <div class="paypalme-card">
                    ...
                    <div class="direct-pay">
                        ...
                        <a href="${subscriptionData.paypalMeLink}" target="_blank" class="paypalme-btn">
                            <i class="fab fa-paypal"></i> Jetzt ${plan.monthly}€ bezahlen
                        </a>
                    </div>
                </div>
                    ...
                    <div class="timeline">
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                ...
                                <div class="timeline-desc">Erste ${plan.monthly}€ Zahlung</div>
                            </div>
                        </div>
                    </div>
                </div>
...
function sendLinkByEmail(email, link, amount) {
    const subject = `Dein PayPal.me Link - ${amount}€/Monat`;
    const body = `
Hallo!
...
function sendSubscriptionEmail(subscription) {
    ...
    const emailData = {
        ...
        body: `
            ...
            - Anzahlung: ${subscription.deposit}€
            - Monatlich: ${subscription.monthly}€
...
function notifyAdmin(subscription) {
    ...
    console.log("Monatlich:", subscription.monthly + "€");
