...
function showPayPalMeSuccess(planType, subscriptionData, paymentDetails) {
    ...
    const formattedDeposit = plan.deposit.toFixed(2);
    ...
    const successHTML = `
        <div class="paypalme-success-container">
            ...
            <div class="paypalme-section">
                ...
                <div class="paypalme-card">
                    ...
                    <div class="link-display">
                        <div class="link-box">
                            <input type="text" readonly value="https://www.paypal.com/paypalme/kozan885/9.99" id="paypalme-link">
                    ...
                    <div class="direct-pay">
                        ...
                        <a href="https://www.paypal.com/paypalme/kozan885/9.99" target="_blank" class="paypalme-btn">
            ...
            <div class="success-actions">
                <button onclick="sendLinkByEmail('${subscriptionData.customerEmail}', 'https://www.paypal.com/paypalme/kozan885/9.99', ${plan.monthly})" class="action-btn email-btn">
...
function sendSubscriptionEmail(subscription) {
    ...
    const formattedDeposit = subscription.deposit.toFixed(2);
